...
export default function Navigation() {
  ...
  const loadNotifications = (userId: string) => {
    ...
    if (currentUser && currentUser.notifications) {
      ...
      setUnreadCount(currentUser.notifications.filter((n: Notification) => !n.read).length)
    }
  }
  ...
  const navItems = [
    ...
    { name: "Diet Plan", href: "/diet-plan", icon: Brain },
    { name: "Emotional Goals", href: "/emotional-goals", icon: Heart },
